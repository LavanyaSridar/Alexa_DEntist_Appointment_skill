...
calendar_id = "ff2b6859ad095ca02ea8da383c468f83ddce5d70ed830a6e64dca7ab835d6412@group.calendar.google.com"
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome to dentist appointment skill. you can say 'I want to schedule an appointment'"
...
class ScheduleIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = f"Your schedule on {date} at {time} is successfully done. "
